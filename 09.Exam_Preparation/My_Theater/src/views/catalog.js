...
import { getAll } from '../api/theaters.js';


const catalogTemplate = (theaters) => html`
    ...
    <div class="eventsInfo">
        ...
        <div class="info">
            ...
            <div class="info-buttons">
                <a class="btn-details" href="/catalog/${theater._id}">Details</a>
            </div>
        </div>
    </div>
    `;
...
export async function catalogView(ctx) {
    let theaters = await getAll();

    ctx.render(catalogTemplate(theaters));
}
